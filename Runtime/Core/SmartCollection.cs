...
public class CustomAssetModificationProcessor : UnityEditor.AssetModificationProcessor
{
    ...
    private static AssetMoveResult OnWillMoveAsset(string sourcePath, string destinationPath)
    {
        ...
        SubAssetCollection collectionAttribute = AssetDatabase.GetMainAssetTypeAtPath(sourcePath).GetCustomAttribute(typeof(SubAssetCollection)) as SubAssetCollection;
